...
dofile(vim.fn.expand("~/dotfiles/vimrc/custom-functions.lua"))
dofile(vim.fn.expand("~/dotfiles/vimrc/plugins-setup.lua"))
dofile(vim.fn.expand("~/dotfiles/neovide.lua"))
